        ...
        $scope.ontInfoQuery = function () {
            ...
            OntInfoResource.query({
              ip : storageService.getIP()
                ...
                $scope.$emit('getCmdMenu', $scope.ontInfo.Type);

                if(storageService.get("ont") === undefined) {
                    console.log("first login");
                    var saveOnuInfoArr = [];
                    saveOnuInfoArr.push("GPONSN,Type,Code,Software,Hardware,LOID,Password,SLID,MAC,Serial,OperatorID,Date,Interface"+"\n");
